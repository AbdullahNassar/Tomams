                                        ...
                                        <table class="table table-striped table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('admin.slider.edit' , ['id' => $slider->id]) }}" class="btn green btn-sm btn-outline sbold uppercase"><i class="fa fa-edit"></i> Edit   </a><br><br>
                                                        <button type="button" class="btn btn-danger btndelet" data-url="{{ route('admin.slider.delete' , ['id' => $slider->id]) }}" >
