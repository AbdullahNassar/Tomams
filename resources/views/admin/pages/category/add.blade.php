                        ...
                        <div class="col-md-12">
                            <div class="portlet box green">
                                ...
                                <div class="portlet-body form">
                                    <!-- BEGIN FORM-->
                                    <form action="{{route('admin.category.add')}}" enctype="multipart/form-data" method="post"  onsubmit="return false;">
                                        <div class="form-body">
                                            {{ csrf_field() }}
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <div class="choose-img">
                                                        ...
                                                        <input type="hidden" value="categories" id="storage" >
                                                        <input type="hidden" name="image" id="img" >
                                                        <input type="file" name="image" id="image" required>
                                                        <p style="font-size: large;">Choose Category Icon</p>
                                                    </div><!-- End Choose-Img -->
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-4 control-label">Category Name in Arabic :</label>
                                                <div class="col-md-8">
                                                    <div class="input-group">
                                                        <span class="input-group-addon ">
                                                            <i class="fa fa-user"></i>
                                                        </span>
                                                        <input type="text" name="cat_name_ar" class="form-control" placeholder="Category Name in Arabic..."> 
                                                    </div>
                                                </div>
                                            </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-4 control-label">Category Name in English :</label>
                                                <div class="col-md-8">
                                                    <div class="input-group">
                                                        <span class="input-group-addon ">
                                                            <i class="fa fa-user"></i>
                                                        </span>
                                                        <input type="text" name="cat_name_en" class="form-control" placeholder="Category Name in English..."> 
                                                    </div>
                                                </div>
                                            </div>
                                            </div>
