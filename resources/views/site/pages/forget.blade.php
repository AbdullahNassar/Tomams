                            ...
                            <div class="item-box padding-30">
                                <div class="row">
                                    <div class="col-md-6 col-md-offset-3">
                                        <h3 class="head-border" style="text-align: center;">قم بادخال بريدك الالكترونى</h3><br>
                                        <form action="{{route('password.get')}}" enctype="multipart/form-data" method="post" onsubmit="return false;">
                                            {{ csrf_field() }}
                                            <div class="form-group">
                                                <input name="email" class="form-control" placeholder="من فضلك أدخل بريدك الالكترونى" type="email">
                                            </div><!--End col-md-6-->
                                            <button type="submit" class="custom-btn addBTNN" style="margin-right: 200px;">أرسل</button>
                                        </form>
                                    </div><!--End col-md-6-->
                                </div><!--End row-->
                            </div><!--End item-box-->
